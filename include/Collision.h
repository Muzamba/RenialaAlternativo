...
public:
    ...
    static inline bool IsColliding(Rect& a, Rect& b, float angleOfA, float angleOfB) {
        Vec2 A[] = { Vec2( a.pos.x, a.pos.y + a.size.y ),
                     Vec2( a.pos.x + a.size.x, a.pos.y + a.size.y ),
                     Vec2( a.pos.x + a.size.x, a.pos.y ),
                     Vec2( a.pos.x, a.pos.y )
        };
        Vec2 B[] = { Vec2( b.pos.x, b.pos.y + b.size.y ),
                     Vec2( b.pos.x + b.size.x, b.pos.y + b.size.y ),
                     Vec2( b.pos.x + b.size.x, b.pos.y ),
                     Vec2( b.pos.x, b.pos.y )
        };
